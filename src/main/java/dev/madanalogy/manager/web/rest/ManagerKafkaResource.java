...
@RestController
@RequestMapping("/api/manager-kafka")
public class ManagerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ManagerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ManagerKafkaResource(KafkaProperties kafkaProperties) {
