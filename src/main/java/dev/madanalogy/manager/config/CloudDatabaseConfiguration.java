package dev.madanalogy.manager.config;
...
@Configuration
@EnableMongoRepositories("dev.madanalogy.manager.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("dev.madanalogy.manager.config.dbmigrations");
