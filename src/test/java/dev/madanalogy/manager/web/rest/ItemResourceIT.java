...
public class ItemResourceIT {
    ...
    private static final Double DEFAULT_COST = 0.01D;
    ...
    public void createItem() throws Exception {
        ...
        // Create the Item
        restItemMockMvc.perform(post("/api/items").with(csrf())
    ...
    public void updateItem() throws Exception {
        ...
        restItemMockMvc.perform(put("/api/items").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deleteItem() throws Exception {
        ...
        // Delete the item
        restItemMockMvc.perform(delete("/api/items/{id}", item.getId()).with(csrf())
