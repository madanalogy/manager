package dev.madanalogy.manager.web.rest;

import dev.madanalogy.manager.ManagerApp;
import dev.madanalogy.manager.config.Constants;
import dev.madanalogy.manager.domain.PersistentToken;
import dev.madanalogy.manager.domain.User;
import dev.madanalogy.manager.repository.AuthorityRepository;
import dev.madanalogy.manager.repository.PersistentTokenRepository;
import dev.madanalogy.manager.repository.UserRepository;
import dev.madanalogy.manager.security.AuthoritiesConstants;
import dev.madanalogy.manager.service.UserService;
import dev.madanalogy.manager.service.dto.PasswordChangeDTO;
import dev.madanalogy.manager.service.dto.UserDTO;
import dev.madanalogy.manager.web.rest.vm.KeyAndPasswordVM;
import dev.madanalogy.manager.web.rest.vm.ManagedUserVM;
...
import static dev.madanalogy.manager.web.rest.AccountResourceIT.TEST_USER_LOGIN;
